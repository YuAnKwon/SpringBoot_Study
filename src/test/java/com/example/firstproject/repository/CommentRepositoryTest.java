...
@DataJpaTest //리파지터리를 테스트 하므로 JPA와 연동해 테스트 하겠다는 선언.
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3 : 999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 게시글은 없음.");
        }
        /* Case 3 : -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 게시글은 없음.");
        }
    }
